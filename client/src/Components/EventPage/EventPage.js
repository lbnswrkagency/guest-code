        ...
        {isLoading ? (
          ...
          <>
            <header className="event-page-header">
              ...
              <img
                src="https://guest-code.s3.eu-north-1.amazonaws.com/server/HEADER26062024.png"
                alt=""
            ...
            {event.guestCode && (
              ...
              >
                ...
                <div className="event-page-guestcode-form">
                  ...
                  <p>BOLIVAR - Wednesdasy - 26.06.2024</p>
                  <input
                    type="text"
