...
const EventForm = ({
  ...
  useEffect(() => {
    if (
      ...
      const generatedPath = generateSmartDropboxPath(
        ...
        videoPathStructure,
        selectedBrand.dropboxDateFormat, // Pass the user's preferred date format
        selectedBrand.dropboxVideoSubfolder // Pass the video subfolder
      );
      if (generatedPath && generatedPath !== formData.dropboxVideoFolderPath) {
  ...
  // Function to regenerate video path suggestion
  const regenerateDropboxVideoPath = () => {
            ...
            <div className="form-section video-gallery-section">
              ...
              {dropboxVideoPathSuggestion && (
                <div className="dropbox-suggestion-banner">
                  <div className="suggestion-content">
                    <span className="suggestion-text">
                      💡 Suggested: <code>{dropboxVideoPathSuggestion}</code>
                    </span>
                    <div className="suggestion-actions">
                      <button
                        type="button"
                        className="suggestion-btn accept"
                        onClick={acceptDropboxVideoSuggestion}
                        title="Use this path"
                      >
                        <FaCheck /> Use
                      </button>
                      <button
                        type="button"
                        className="suggestion-btn reject"
                        onClick={() => setDropboxVideoPathSuggestion("")}
                        title="Dismiss"
                      >
                        <FaTimes />
                      </button>
              ...
              <div className="folder-path-input">
                <div className="input-with-icon">
                  ...
                  <input
                    ...
                    value={formData.dropboxVideoFolderPath || ""}
                    onChange={handleInputChange}
                    placeholder="Video folder path (auto-generated from brand settings)"
                  />
                </div>
                <div className="path-actions">
                  {selectedBrand?.dropboxBaseFolder && formData.startDate && (
                    <button
                      type="button"
                      className="action-btn regenerate"
                      onClick={regenerateDropboxVideoPath}
                      title="Auto-generate path"
                    >
                      <RiRefreshLine />
                    </button>
