...
const EventForm = ({
  ...
  }, [events, selectedBrand?.dropboxBaseFolder, selectedBrand?.dropboxPathStructure, formData.startDate, isDropboxPathAutoGenerated]);
  ...
  // Function to accept the auto-generated suggestion
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                <label>Dropbox Gallery Folder</label>
                  ...
                  <div className="dropbox-suggestion-banner">
                    <div className="suggestion-content">
                      <span className="suggestion-text">
                        💡 Suggested path: <code>{dropboxPathSuggestion}</code>
                      </span>
                ...
                <div className="input-with-icon">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder={selectedBrand?.dropboxBaseFolder ? 
                      `Auto-generated: ${selectedBrand.dropboxBaseFolder}${selectedBrand.dropboxPathStructure || '/Events/{DDMMYY}/photos'}` : 
                      "e.g., /events/2024/december/party-name"
                    }
                  />
                  ...
                  {selectedBrand?.dropboxBaseFolder && formData.startDate && (
                    <button
                      type="button"
                      className="regenerate-path-btn"
                      onClick={regenerateDropboxPath}
                      title="Generate path from brand and date"
                    >
                      🔄
                    </button>
                  )}
                ...
                <div className="dropbox-browser-section">
                  <div className="section-divider">
                    <span>or browse your Dropbox folders</span>
                  </div>
                  <DropboxFolderBrowser
                    selectedPath={formData.dropboxFolderPath || ""}
                    onSelectPath={handleDropboxFolderSelect}
                    placeholder="Browse and select a folder from your Dropbox"
                ...
                <small className="input-hint">
                  {selectedBrand?.dropboxBaseFolder ? (
                    <>Auto-generated based on brand folder and event date. You can modify if needed.</>
                  ) : (
                    <>Enter the path to your Dropbox folder containing event photos/videos</>
                  )}
                </small>
                
                {/* Show path structure info */}
                {selectedBrand?.dropboxBaseFolder && (
                  <small className="path-structure-info">
                    📁 Structure: <code>{selectedBrand.dropboxBaseFolder}{selectedBrand.dropboxPathStructure || '/Events/{DDMMYY}/photos'}</code>
                  </small>
                )}
              </div>
            </div>
